...
class BaseDataset(Dataset):
    def __init__(
        ...
        self.images_path =  args['images_path']  #'/home/comppec/Downloads/VirtualMultiplexer-master/data/skin_images' 
    ...
    def _get_splits(self):
        ...
        #         src_split.append(x)
        #         dst_split.append(y)
        # self.src_split = src_split# for testing purposes
        # self.dst_split = dst_split
        self.dst_split = ['A1_TMA_15_02_IIB_HE', 'A2_TMA_15_02_IVB_HE']
        self.src_split = ['A1_TMA_15_02_IIB_NKX3', 'A2_TMA_15_02_IVB_NKX3']
    def _base_load(self):
