...
class PostProcess:
    ...
    def _get_tissue_mask(self):
        tissue_mask_path = os.path.join(self.tissue_masks_path, os.path.basename(self.src_image_path)) #os.path.join('data/skin_tissue_masks/HE', os.path.basename(self.src_image_path)) # 
